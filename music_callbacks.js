...
function initApplication()
{
    ...
    CHECK_RESULT( gSystem.getEvent("event:/Music/Level 02", outval) );
    ...
    CHECK_RESULT( eventDescription.getParameterDescriptionByName("Area", parameterDescription) );
