...
function initApplication()
{
    ...
    CHECK_RESULT( gSystem.loadBankFile("/Music.bank", FMOD.STUDIO_LOAD_BANK_NORMAL, bankhandle) );

    var eventDescription = {};
    CHECK_RESULT( gSystem.getEvent("event:/Music/XFade", eventDescription) );
    ...
    var paramDesc = {};
    CHECK_RESULT( eventDescription.val.getParameterDescriptionByName("XfadeDiscrete", paramDesc) );
